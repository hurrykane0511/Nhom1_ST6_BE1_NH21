...
if (isset($_POST['signup'])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $sql = "INSERT INTO `tbl_user` (`user_id` ,`firstname`, `lastname`, `password`, `email`) 
        ...
        if (mysqli_query($conn, $sql)) {
            echo "Tên: " . $_POST['firstname'] . "<br/>";
            echo "Họ: " . $_POST['lastname'] . "<br/>";
            echo "Email đăng nhập: " . $_POST['email'] . "<br/>";
            echo "Mật khẩu: " . $_POST['password'] . "<br/>";
        } else {
            echo '<script language="javascript">alert("Có lỗi trong quá trình xử lý"); window.location="sigup.php";</script>';
        }
    }
}
