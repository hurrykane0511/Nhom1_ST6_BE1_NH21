...
function getAllProducts($$firstname)
{
    $firstname   = addslashes($_POST['firstname']);
    $sql = self::$connection->prepare("SELECT firstname FROM `tbl_user` WHERE firstname = '$firstname'");
...
if (mysqli_num_rows(mysqli_query(getAllProduct())) > 0) {
